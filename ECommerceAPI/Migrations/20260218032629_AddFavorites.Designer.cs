...
namespace ECommerceAPI.Migrations
{
    ...
    [Migration("20260218032629_AddFavorites")]
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Ahmedabad",
                            Country = "India",
                            Created = new DateTime(2026, 2, 18, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            IsDefault = true,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 13, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            DeliveryDate = new DateTime(2026, 2, 20, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            NetAmount = 25998.00m,
                            OrderDate = new DateTime(2026, 2, 13, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            OrderNo = "ORD001",
                            Status = "Pending",
                        ...
                        new
                        {
                            OrderID = 2,
                            AddressID = 3,
                            Created = new DateTime(2026, 2, 15, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            DeliveryDate = new DateTime(2026, 2, 19, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            NetAmount = 55000.00m,
                            OrderDate = new DateTime(2026, 2, 15, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            OrderNo = "ORD002",
                            Status = "Pending",
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 13, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                        ...
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 15, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
            ...
            modelBuilder.Entity("ECommerceAPI.Models.ProductReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 14, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            ProductID = 1,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 16, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            ProductID = 2,
                            Rating = 4,
                            Title = "Good Laptop",
                            UserID = 3
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 17, 8, 56, 26, 379, DateTimeKind.Local).AddTicks(9157),
                            ProductID = 3,
                            Rating = 4,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$fT5a.jyLyfHVfHrgdAQwhO1RigV7syYzmjZrwhJL7LNoUDq35N.Su",
                            Phone = "9876543210",
                            UserName = "Admin User",
                            UserTypeID = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$bYP/b0VZ6JLeOo6DVRPaTe1R.eMZxjse3/JVNr3x7N9mVsDKAESGG",
                            Phone = "9876543211",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$1e3ekogXfgcUc0YJfzrDC.Isrfdy8RwhgC6jK5z8bd3DfaznynB5e",
                            Phone = "9876543212",
                            UserName = "Priya Shah",
                            UserTypeID = 2
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$/51BGUJ3cZzvop6IE0OaFeUOgHJNkEmZR4rg7x4h6IX7hSxjcvO3G",
                            Phone = "9876543213",
