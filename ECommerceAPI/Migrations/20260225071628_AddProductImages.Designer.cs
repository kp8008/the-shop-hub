...
namespace ECommerceAPI.Migrations
{
    ...
    [Migration("20260225071628_AddProductImages")]
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Ahmedabad",
                            Country = "India",
                            Created = new DateTime(2026, 2, 25, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            IsDefault = true,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 20, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            DeliveryDate = new DateTime(2026, 2, 27, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            NetAmount = 25998.00m,
                            OrderDate = new DateTime(2026, 2, 20, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            OrderNo = "ORD001",
                            Status = "Pending",
                        ...
                        new
                        {
                            OrderID = 2,
                            AddressID = 3,
                            Created = new DateTime(2026, 2, 22, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            DeliveryDate = new DateTime(2026, 2, 26, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            NetAmount = 55000.00m,
                            OrderDate = new DateTime(2026, 2, 22, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            OrderNo = "ORD002",
                            Status = "Pending",
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 20, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                        ...
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 22, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
            ...
            modelBuilder.Entity("ECommerceAPI.Models.ProductReview", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ReviewID = 1,
                            Comment = "Very good quality and fast performance. Highly recommended!",
                            Created = new DateTime(2026, 2, 21, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            ProductID = 1,
                            Rating = 5,
                        ...
                        {
                            ReviewID = 2,
                            Comment = "Nice laptop with good features. Battery life could be better.",
                            Created = new DateTime(2026, 2, 23, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            ProductID = 2,
                            Rating = 4,
                            Title = "Good Laptop",
                            UserID = 3
                        ...
                        {
                            ReviewID = 3,
                            Comment = "Good quality fabric and comfortable to wear.",
                            Created = new DateTime(2026, 2, 24, 12, 46, 27, 398, DateTimeKind.Local).AddTicks(2587),
                            ProductID = 3,
                            Rating = 4,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$BPPu2vvvjiZE86G1mRgyqeq2OypRx.f0ClnJu37bCUPZ0EfrepJRS",
                            Phone = "9876543210",
                            UserName = "Admin User",
                            UserTypeID = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$C.5DZbjs5b2RKP0WfEQq1OlUl3lAFe50fB.HxVJmPivAKJWlZ2hzC",
                            Phone = "9876543211",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$3aNho89LYR4UGLpx/AS/u.4D7m36ENDr0ZpQs.pUsfxoIpjU5RbLe",
                            Phone = "9876543212",
                            UserName = "Priya Shah",
                            UserTypeID = 2
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$w3bC8dFs4cjQW3dkqPwvue6Z61s9GFvtOvX84KR6eTSAR1UGwUj8y",
                            Phone = "9876543213",
