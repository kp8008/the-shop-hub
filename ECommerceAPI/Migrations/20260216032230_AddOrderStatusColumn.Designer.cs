...
namespace ECommerceAPI.Migrations
{
    ...
    [Migration("20260216032230_AddOrderStatusColumn")]
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Address", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Ahmedabad",
                            Country = "India",
                            Created = new DateTime(2026, 2, 16, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            IsDefault = true,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 11, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            DeliveryDate = new DateTime(2026, 2, 18, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            NetAmount = 25998.00m,
                            OrderDate = new DateTime(2026, 2, 11, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            OrderNo = "ORD001",
                            Status = "Pending",
                        ...
                        new
                        {
                            OrderID = 2,
                            AddressID = 3,
                            Created = new DateTime(2026, 2, 13, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            DeliveryDate = new DateTime(2026, 2, 17, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            NetAmount = 55000.00m,
                            OrderDate = new DateTime(2026, 2, 13, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            OrderNo = "ORD002",
                            Status = "Pending",
            ...
            modelBuilder.Entity("ECommerceAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 11, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                        ...
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2026, 2, 13, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
            ...
            modelBuilder.Entity("ECommerceAPI.Models.ProductReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 12, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            ProductID = 1,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 14, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            ProductID = 2,
                            Rating = 4,
                            Title = "Good Laptop",
                            UserID = 3
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2026, 2, 15, 8, 52, 29, 383, DateTimeKind.Local).AddTicks(7594),
                            ProductID = 3,
                            Rating = 4,
            ...
            modelBuilder.Entity("ECommerceAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$/hGayGE07wBoFlOv2ZtL/e/Df4bcMLDwG8JSZbwhr2Kufo3pMfOTu",
                            Phone = "9876543210",
                            UserName = "Admin User",
                            UserTypeID = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$btjtrtr37pn7a9nbvUsYd.J1TKqFWtDkZBOq2lpK4R.My96NJW3KK",
                            Phone = "9876543211",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$y3vEDFSMlNjF3MbIbRCROO5V9RryandIj6/NPlWdQsxirXmWYuRa.",
                            Phone = "9876543212",
                            UserName = "Priya Shah",
                            UserTypeID = 2
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "$2a$11$r39ffBMEKFiMOhigb0G/cuKIG.wPNsnfzo0RSgrkOlAxhiE66UrfS",
                            Phone = "9876543213",
